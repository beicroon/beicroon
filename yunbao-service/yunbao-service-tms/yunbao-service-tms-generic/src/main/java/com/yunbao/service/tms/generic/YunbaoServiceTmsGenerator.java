package com.yunbao.service.tms.generic;
...
public class YunbaoServiceTmsGenerator {

    private static final String ROOT_PATH = "yunbao-service";

    private static final String MODULE_NAME = "yunbao-service-tms";

    private static final String BASE_PACKAGE = "com.yunbao.service.tms";
