package com.yunbao.service.oms.generic;
...
public class YunbaoServiceOmsGenerator {

    private static final String ROOT_PATH = "yunbao-service";

    private static final String MODULE_NAME = "yunbao-service-oms";

    private static final String BASE_PACKAGE = "com.yunbao.service.oms";
