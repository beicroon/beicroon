...
public final class MybatisPlusHelper {
    ...
    public static <T extends GenericModel> QueryWrapper<T> getWrapper(IQueryWrapper<T> wrapper) {
        return (QueryWrapper<T>) wrapper.getWrapper();
    }

    @SuppressWarnings("unchecked")
    public static <T extends GenericModel> UpdateWrapper<T> getWrapper(IUpdateWrapper<T> wrapper) {
        return (UpdateWrapper<T>) wrapper.getWrapper();
    }
