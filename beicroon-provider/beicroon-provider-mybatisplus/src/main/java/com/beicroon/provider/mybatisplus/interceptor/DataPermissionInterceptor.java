...
@Component
public class DataPermissionInterceptor extends BaseMultiTableInnerInterceptor implements InnerInterceptor, DatabaseInterceptor {
    ...
    public Expression buildTableExpression(Table table, Expression where, String whereSegment) {
        ...
        if (!PERMISSION_CACHE.containsKey(whereSegment)) {
            PERMISSION_CACHE.put(whereSegment, permissions = MybatisPlusHelper.getPermissions(whereSegment));
        } else {
