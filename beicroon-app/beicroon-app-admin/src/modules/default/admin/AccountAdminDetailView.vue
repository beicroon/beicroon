...
<template>
  <beicroon-form class="beicroon-dialog-view">
    <div class="beicroon-dialog-main beicroon-dialog-input" v-if="data">
      ...
      <beicroon-input disabled class="column" label="昵称" v-model="data.name"></beicroon-input>
      <beicroon-input disabled class="column" label="账号" v-model="data.username"></beicroon-input>
      <beicroon-input disabled class="column" label="电话" v-model="data.phone"></beicroon-input>
      <beicroon-input disabled class="column" label="邮箱" v-model="data.email"></beicroon-input>
    </div>
