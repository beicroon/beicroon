...
import httpUtils, {BeicroonGenericVO, BeicroonQueryDTO, BeicroonRequestConfig, BeicroonTabVO} from "@u/http.utils.ts";
...
const setPages = async (module: BeicroonPaginator, page: number, totalSize: number) => {
    module.page = page;
...
const handlePageRequest = async <DTO extends BeicroonQueryDTO, VO extends BeicroonGenericVO>(module: BeicroonModule<DTO, VO>, config: BeicroonRequestConfig, page: number, data: DTO) => {
...
export type BeicroonModule<DTO extends BeicroonQueryDTO, VO extends BeicroonGenericVO> = {
    params: DTO,
    clear: () => void,
    loading: () => boolean,
...
const newModule = <DTO extends BeicroonQueryDTO, VO extends BeicroonGenericVO>(requestConfig: ModuleRequestConfig) => {
    const module = reactive({
        ...
        } as BeicroonPaginator,
    }) as BeicroonModule<DTO, VO>;
