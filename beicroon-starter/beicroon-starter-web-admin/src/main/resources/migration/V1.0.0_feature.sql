...
VALUES
    (1825706731063808302, 'ROOT', '超级管理员', 'root', 'b13bc5fefc72a6a06c6c172d227f5c39967cdbbcdf8f20b5fc39f175bfb608a5', 'true', '超级管理员', '超级管理员'),
    (1825706731063808332, 'ADMIN', '管理员', 'admin', 'faf1f45a58caa5b6bdb451adb8a71dfe697472e5c85516ec40fde6f989719610', 'false', '超级管理员', '超级管理员');

INSERT INTO `admin_resource_menu`
    (`id`, `parent_id`, `parent_code`, `parent_name`, `code`, `name`, `path`, `creator_name`, `modifier_name`)
VALUES
    (1825707485132558337, 0, '', '', 'SYSTEM_SETTING', '系统设置', '', '超级管理员', '超级管理员'),
    (1825707094248591361, 1825707485132558337, 'SYSTEM_SETTING', '系统设置', 'ACCOUNT_MANAGER', '账号管理', '', '超级管理员', '超级管理员'),
    (1825707293197012994, 1825707094248591361, 'ACCOUNT_MANAGER', '账号管理', 'ACCOUNT_ADMIN', '后台账号', '/account/admin', '超级管理员', '超级管理员'),
    (1825707757028315138, 1825707485132558337, 'SYSTEM_SETTING', '系统设置', 'RESOURCE_MANAGER', '资源管理', '', '超级管理员', '超级管理员'),
    (1825707969033605121, 1825707757028315138, 'RESOURCE_MANAGER', '资源管理', 'RESOURCE_MENU', '菜单管理', '/resource/menu', '超级管理员', '超级管理员'),
    (1825707969033606521, 1825707757028315138, 'RESOURCE_MANAGER', '资源管理', 'RESOURCE_ROLE', '角色管理', '/resource/role', '超级管理员', '超级管理员');

INSERT INTO `admin_resource_role`
    (`id`, `code`, `name`, `remark`, `root_flag`, `creator_name`, `modifier_name`)
VALUES
    (1825706731063808102, 'ROOT', '超级管理员', '超级管理员', 'true', '超级管理员', '超级管理员'),
...
values
    (1825706731063808302, 1825706731063808102, '超级管理员', '超级管理员');
