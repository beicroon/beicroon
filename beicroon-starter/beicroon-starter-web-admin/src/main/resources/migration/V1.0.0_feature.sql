...
VALUES (1825706731063808302, 'root', 'root', 'root', 'b13bc5fefc72a6a06c6c172d227f5c39967cdbbcdf8f20b5fc39f175bfb608a5',
        'true', 'root', 'root'),
       (1825706731063808332, 'admin', 'admin', 'admin',
        'faf1f45a58caa5b6bdb451adb8a71dfe697472e5c85516ec40fde6f989719610', 'false', 'root', 'root');

INSERT INTO `admin_resource_menu`
(`id`, `parent_id`, `parent_code`, `parent_name`, `code`, `name`, `path`, `creator_name`, `modifier_name`)
VALUES (1825706731063808002, 0, '', '', 'ACCOUNT_CENTER', '账号中心', '/account/center', 'root', 'root'),
       (1825707094248591361, 1825706731063808002, 'ACCOUNT_CENTER', '账号中心', 'ACCOUNT_MANAGER', '账号管理',
        '/account/manager', 'root', 'root'),
...
values (1825706731063808302, 1825706731063808102, 'root', 'root');
